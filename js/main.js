...
uniqueUsernames.addUser('john_doe'); // Это действие не изменит набор, так как 'john_doe' уже существует

console.log(`Имеется 'john_doe': ${uniqueUsernames.exists('john_doe')}`); // true
console.log(`Количество уникальных имен: ${uniqueUsernames.count()}`); // 2
